...
func TestFulfillmentList(t *testing.T) {
	...
	fulfillmentAPI := &FulfillmentAPIOp{client: client, resource: ordersResourceName, resourceID: 123}

	fulfillments, err := fulfillmentAPI.List(nil)
	if err != nil {
...
func TestFulfillmentCount(t *testing.T) {
	...
	cnt, err := fulfillmentAPI.Count(nil)
	if err != nil {
	...
	cnt, err = fulfillmentAPI.Count(CountOptions{CreatedAtMin: date})
	if err != nil {
		t.Errorf("Fulfillment.Count returned error: %v", err)
	}
...
func TestFulfillmentGet(t *testing.T) {
	...
	fulfillment, err := fulfillmentAPI.Get(1, nil)
	if err != nil {
...
func TestFulfillmentCreate(t *testing.T) {
	...
	returnedFulfillment, err := fulfillmentAPI.Create(fulfillment)
	if err != nil {
...
func TestFulfillmentUpdate(t *testing.T) {
	...
	returnedFulfillment, err := fulfillmentAPI.Update(fulfillment)
	if err != nil {
...
func TestFulfillmentComplete(t *testing.T) {
	...
	returnedFulfillment, err := fulfillmentAPI.Complete(1)
	if err != nil {
...
func TestFulfillmentTransition(t *testing.T) {
	...
	returnedFulfillment, err := fulfillmentAPI.Open(1)
	if err != nil {
...
func TestFulfillmentCancel(t *testing.T) {
	...
	returnedFulfillment, err := fulfillmentAPI.Cancel(1)
	if err != nil {
