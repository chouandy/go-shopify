...
// LocationAPI is an interface for interfacing with the location endpoints
// of the Shopify API.
...
// LocationAPIOp handles communication with the location related methods of
// the Shopify API.
type LocationAPIOp struct {
	client *Client
}
...
// LocationResource represents the result from the locations/X.json endpoint
type LocationResource struct {
	Location *Location `json:"location"`
}

// LocationsResource represents the result from the locations.json endpoint
type LocationsResource struct {
	Locations []Location `json:"locations"`
}

// List locations
func (s *LocationAPIOp) List(options interface{}) ([]Location, error) {
...
// Get location
func (s *LocationAPIOp) Get(ID int, options interface{}) (*Location, error) {
...
// Count locations
func (s *LocationAPIOp) Count(options interface{}) (int, error) {
